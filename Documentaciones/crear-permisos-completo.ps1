# Script PowerShell para crear TODOS los permisos en MongoDB
# Ejecutar: .\crear-permisos-completo.ps1

$mongoUri = "mongodb://localhost:27017/ms-security"

Write-Host "🚀 Iniciando creación de permisos..." -ForegroundColor Cyan
Write-Host ""
...
# 1. LIMPIAR PERMISOS INCORRECTOS
...
Write-Host "`n🎉 ¡Script completado! Parte 1 de 3 (47 permisos)" -ForegroundColor Green
Write-Host "💡 Para continuar, ejecuta: .\crear-permisos-parte2.ps1" -ForegroundColor Cyan
