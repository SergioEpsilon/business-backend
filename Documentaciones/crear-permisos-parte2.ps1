# Script PowerShell para crear permisos - PARTE 2
# Ejecutar: .\crear-permisos-parte2.ps1
...
Write-Host "`n🎉 ¡Parte 2 completada! (95 permisos totales)" -ForegroundColor Green
Write-Host "💡 Para finalizar, ejecuta: .\crear-permisos-parte3.ps1" -ForegroundColor Cyan
