...
async function fixMigrations() {
  ...
  try {
    ...
    await db.rawQuery('DELETE FROM adonis_schema WHERE name = ?', ['database/migrations/1763055021000_alter_drivers_user_id'])
    await db.rawQuery('DELETE FROM adonis_schema WHERE name = ?', ['database/migrations/1763055023000_alter_drivers_and_shifts_to_string_ids'])
